...
def get_all_box_matches(prediction_boxes, gt_boxes, iou_threshold):
    ...
    while True:
        ...
        #max_iou_indices = np.argwhere(iou_matrix == max_iou)[0]
        ...
        #iou_matrix[max_iou_indices[0], :] = 0
        #iou_matrix[:, max_iou_indices[1]] = 0
        iou_matrix[max_iou_pred_index, :] = 0
        iou_matrix[:, max_iou_gt_index] = 0


        # Add the matched boxes to the output arrays
        #matched_prediction_boxes.append(prediction_boxes[max_iou_indices[0]])
        #matched_gt_boxes.append(gt_boxes[max_iou_indices[1]])
